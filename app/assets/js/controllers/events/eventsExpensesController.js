function EventsExpensesController($scope, $state, $stateParams, snapRemote, UserService, CompanyService, UserInterface, Event, Expense) {
...
EventsExpensesController.$inject = [  '$scope'
                                    , '$state'
                                    , '$stateParams'
                                    , 'snapRemote'
                                    , 'UserService'
