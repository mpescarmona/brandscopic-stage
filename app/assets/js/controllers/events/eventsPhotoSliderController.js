function EventsPhotoSliderController($scope, $state, $stateParams, snapRemote, UserService, CompanyService, UserInterface, Event, Photos, photosService) {
...
EventsPhotoSliderController.$inject = [  '$scope'
                                       , '$state'
                                       , '$stateParams'
                                       , 'snapRemote'
                                       , 'UserService'
