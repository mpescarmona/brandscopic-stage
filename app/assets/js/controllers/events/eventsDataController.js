function EventsDataController($scope, $state, $stateParams, $location, snapRemote, UserService, CompanyService, UserInterface, Event) {
...
EventsDataController.$inject = [  '$scope'
                                , '$state'
                                , '$stateParams'
                                , '$location'
                                , 'snapRemote'
